...
export class SingleTripViewComponent implements OnInit {
  ...
  constructor(private dataService: DataService, private route: ActivatedRoute, public accountService : AccountDataService) {}
  ...
  addingTickets() {
    ...
    this.dataService.updateQuantity(this.trip!.id, this.trip!.maxQuantity, this.trip!.reserved, this.trip, 1)
  }
